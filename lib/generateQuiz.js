...
const getPrompt = ({
  ...
  questions = 1,
    ...
    The difficulty of the questions should be ${difficulty}. and there should be ${questions} questions in the quiz.
...
async function generateQuiz({ images, description, difficulty, questions }) {
  try {
